 ...
 */
function startDebugging(manifestPath, appType, debuggingMethod = defaultDebuggingMethod(), sourceBundleUrlComponents, devServerCommandLine, devServerPort, packagerCommandLine, packagerHost, packagerPort, sideloadCommandLine, enableDebugging = true, enableLiveReload = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (sideloadCommandLine && isDesktopAppType) {
            try {
                ...
                yield process_1.startProcess(sideloadCommandLine);
            }
            catch (err) {
